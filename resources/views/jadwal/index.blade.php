    ...
    <div class="col-sm-12">
        <form action="{{ route('jadwal.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="NamaPerusahaan" class="form-control" id="NamaPerusahaan" placeholder="Nama Perusahaan">
            </div>
            <div class="form-group">
                <label class="form-label" for="AlamatPerusahaan">Alamat Perusahaan</label>
                <input type="text" name="AlamatPerusahaan" class="form-control" id="AlamatPerusahaan" placeholder="Alamat Perusahaan">
            </div>
            <div class="form-group">
                <label class="form-label" for="NamaKaryawan">Nama Karyawan</label>
                <input type="text" name="NamaKaryawan" class="form-control" id="NamaKaryawan" placeholder="Nama Karyawan">
            </div>
            <div class="form-group">
                <label class="form-label" for="JumlahRuangan">Jumlah Ruangan</label>
                <input type="number" name="JumlahRuangan" class="form-control" id="JumlahRuangan" placeholder="Jumlah Ruangan">
            </div>
            <div class="form-group">
