...
<div class="form-group">
                        ...
                        <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" class="form-control form-control-lg" value="{{ old('password') }}" id="password" placeholder="Enter your passcode" name="passwrod">
                                        </div>
                                         @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
